const { jsPDF } = window.jspdf;
        ...
        async function generarmedidaEmbargo() {
            ...
            const Alberto = document.getElementById('Alberto').value || '___';
            ...
            const TEXTO3 = `SEGUNDO: Que el contribuyente adeuda al Municipio de El Banco, Magdalena, la suma total de $ ${totalEmbargo} , correspondiente al Impuesto Predial Unificado, incluidos capital e intereses moratorios, conforme al título ejecutivo constituido por , debidamente ejecutoriado.`;
